...
weight_path = '/data1/zhijietang/vul_data/run_logs/pretrain/109/state_epoch_4.th'
# weight_path = '/data2/zhijietang/vul_data/run_logs/pretrain/105/state_epoch_9.th'
# target_dump_path = '/data2/zhijietang/vul_data/transformers_repos/subset-tests/pdbert-noise10-cfg-ind-e9/pytorch_model.bin'
target_dump_path = '/data1/zhijietang/vul_data/transformers_repos/subset-tests/pdbert-noise10-ind-slr-e4/pytorch_model.bin'
