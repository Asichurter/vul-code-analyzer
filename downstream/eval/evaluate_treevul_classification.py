...
from utils.cmd_args import read_treevul_classification_eval_args

args = read_treevul_classification_eval_args()
...
data_base_path = f"/data1/zhijietang/vul_data/datasets/treevul-CVE/{subfolder}/{subset}/"
