...
from utils.cmd_args import read_fan_vul_det_eval_args

args = read_fan_vul_det_eval_args()
...
data_base_path = f"/data1/zhijietang/vul_data/datasets/Fan_et_al/{subfolder}/{subset}/"
