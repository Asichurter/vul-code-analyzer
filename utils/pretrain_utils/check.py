...
from utils.allennlp_utils.tokenizer_vocab_sensitive_utils import codebert_families, unixcoder_families, microsoft_pretrain_families
...
def check_pretrain_code_field_correctness(special_tokenizer_token_handler_type: str,
    ...
    if special_tokenizer_token_handler_type in codebert_families:
        ...
        special_token_count = 3 + input_mode_count
    else:
